...
<link rel="icon" href="/favicon.png"><link rel="apple-touch-icon" href="/brand/apple-touch-icon.png">
{FONTS}
<style>
...
body{{margin:0;background:var(--marble);color:var(--ink);font-family:"Manrope",system-ui,sans-serif;line-height:1.7;max-width:100vw}}
...
.navlogo{{height:36px;width:auto;border-radius:6px}}
...
/* mobile subnav */
@media(max-width:760px){{.subnav{{position:static;background:var(--marble-2);overflow:visible;white-space:normal}}.subnav .wrap{{flex-wrap:wrap;gap:7px;padding:12px 18px}}.subnav a{{color:var(--pine);background:#fff;border:1px solid var(--line);font-size:.7rem}}.ivs,.dts{{grid-template-columns:1fr}}.cat h2{{font-size:clamp(1.6rem,7vw,2rem)}}}}
@media(max-width:640px){{.hero{{height:46vh}}}}
</style></head><body>
<header class="nav"><div class="inner"><span class="brandwrap"><img class="navlogo" src="brand/logo-icon.png" alt="Casa Valesa"><a class="brand" href="index.html">Casa <b>Valesa</b></a><span class="loc-badge"><svg viewBox="0 0 24 24" width="15" height="15" aria-hidden="true"><path fill="#1F7A78" d="M3 16c2-5 5-8 9-8s7 3 9 8c-3 2-5.5 2-9 2s-6 0-9-2z"/><circle cx="18" cy="6" r="2.1" fill="#E3A93C"/><path stroke="#7fb9b3" stroke-width="1.3" fill="none" d="M2 20c2 1 4 1 6 0s4-1 6 0 4 1 6 0"/></svg>Thassos · Greece</span></span>
